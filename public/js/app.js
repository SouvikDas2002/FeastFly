...
var _loop = function _loop(i) {
  addToCart[i].onclick = function () {
    var itemData = JSON.parse(addToCart[i].dataset.items);
    updateCart(itemData);
...
var order = document.getElementById('hiddenInput') ? document.getElementById('hiddenInput').value : null;
order = JSON.parse(order);
// console.log(order);

var status = document.getElementsByClassName('status_line');
